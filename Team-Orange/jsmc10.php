    ...
    <div id="intro">
      <div class="test-container">
        ...
        <ul class="list-quiz">
          ...
          <li class="odd wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="550ms"><strong>Topic: </strong>JavaScript (JS)</li>
        </ul>
         <a href="qMultipleChoice.php?n=1" class="start">Start Quiz</a>
      </div>
    <section class="learning-button">
      <div class="caption">
        <a class="btn toggle-btn" href="js.php">Go Back</a>
      </div>
    </section>
  </div>
