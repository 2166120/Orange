...
<body>
    <div id="intro">
      <div class="test-container">
        <h2>Directions: Read the questions carefully and choose correct answer.</h2>
        <ul class="list-quiz">
          ...
          <li class="odd wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="550ms"><strong>Topic: </strong>HyperText Transfer Protocol (HTTP)</li>
        </ul>
         <a href="qMultipleChoice.php?n=1" class="start">Start Quiz</a>
      </div>
    <section class="learning-button">
      <div class="caption">
        <a class="btn toggle-btn" href="http.php">Go Back</a>
      </div>
    </section>
  </div>
