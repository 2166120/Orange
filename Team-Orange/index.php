      ...
      <section class="site-section bg-light">
        <div class="container">
            ...
            <div class="col-md-12 text-center">
                ...
                <p class="lead">
                <h1>about.</h1>
                OrangeQuizzer is an interactive website application that helps the users to learn and at the same time have fun in learning one topic each from HyperText Transfer Protocol (HTTP), Cascading Style Sheets (CSS) and JavaScript (JS). OrangeQuizzer provides good learning materials and quizzes.</p>
  ...
  <footer id="footer">
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <p>Copyright &copy; 2019 Team Orange | Web Systems & Technologies</p></p>
          </div>
          <div class="col-sm-6">
